...
class RapidinhoIcon {
  static final fontFamily = 'Fontello';
  static final homeIcon = IconData(0xe803, fontFamily: fontFamily);
  static final motorCycle = IconData(0xe806, fontFamily: fontFamily);
  static final deliveryMotorCycle = IconData(0xe809, fontFamily: fontFamily);
