...
import 'package:rapidinho/ui/login_page.dart';
...
class SplashPage extends StatelessWidget {
  ...
  Widget _buildSplashAnimation(BuildContext context, Widget child) {
    return Stack(children: [
      ...
      Align(
        alignment:
            Alignment.center.add(Alignment(0.0, animation.logoAlignment.value)),
        child: Image.asset('assets/images/rapidinho_transparent_white.png',
      ...
      Align(
          ...
          child: IgnorePointer(
            ...
            child: Material(
              ...
              child: Text('Entregas na hora',
                  style: TextStyle(
                      fontFamily: 'Rajdhani',
                      color: Colors.white
                          .withOpacity(animation.sloganOpacity.value),
                      fontSize: 15.0,
                      letterSpacing: 1.5,
...
class _SplashPageAnimator extends State<SplashPageAnimator>
  ...
  void initState() {
    ...
    Future.delayed(Duration(seconds: 3)).then((_) => _controller.forward());
  }
