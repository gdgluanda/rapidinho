...
class HomeCardItem extends StatelessWidget {
  ...
  HomeCardItem(this.title, this.action, this.backgroundImage, this.animation);
              ...
              child: new Container(
                ...
                child: ClipRRect(
                  ...
                  child: new Image(
                    height: 120.0,
                    fit: BoxFit.cover,
                    image: backgroundImage != null ? backgroundImage : new AssetImage("assets/images/featured_meal.jpg"),
                  ),
                ),
              ),
